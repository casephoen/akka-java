...
public class HelloWord extends UntypedActor {
	public static void main(String[] args) {
		...
		/*
		 * ActorSystem system = ActorSystem.create("akka"); ActorRef rcActor =
		 * system.actorOf(Props.create(HelloWord.class), "helloWorld");
		 * rcActor.tell("hi", ActorRef.noSender()); // Thread.sleep(3000); //
		 * Actor树 ActorSelection as = system.actorSelection("/user/helloWorld");
